...
export const AuthPage = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (data?.dev_login_code) {
        setOtp(data.dev_login_code);
      }
      setMode("otp");
                ...
                <form onSubmit={handleLogin} className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    <button
                      ...
                      className="flex items-center justify-center gap-2 border border-slate-200 dark:border-slate-700 py-2 rounded-lg text-sm font-medium hover:bg-slate-50 dark:hover:bg-slate-800 transition-all"
                    >
                ...
                <form onSubmit={handleVerifyOtp} className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        placeholder="000000"
                        className="w-full pl-10 pr-4 py-3 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-700 rounded-lg text-lg font-mono tracking-[0.5em] text-center text-slate-900 dark:text-slate-100 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all"
                        maxLength={6}
                        value={otp}
                ...
                <form onSubmit={handleSignup} className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-700 rounded-lg text-sm text-slate-900 dark:text-slate-100 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all"
                      value={name}
